...
function mouseMoved() {
	if (eventLog.length > 0 && eventLog[eventLog.length - 1].includes("mouseMoved")) {
...
function mouseDragged() {
	if (eventLog.length > 0 && eventLog[eventLog.length - 1].includes("mouseDragged")) {
...
function touchMoved() {
	if (eventLog.length > 0 && eventLog[eventLog.length - 1].includes("touchMoved")) {
