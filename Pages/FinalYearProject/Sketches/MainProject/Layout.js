class Layout {
	...
	update() {
		...
		this.subSubPrimarySquare_x = this.subPrimarySquare_x + (this.subPrimarySquare_w - this.subSubPrimarySquare_w) / 2;
		this.subSubPrimarySquare_y = this.subPrimarySquare_y + (this.subPrimarySquare_h - this.subSubPrimarySquare_h) / 2;
		...
		this.subSubPrimarySquareTR_x = this.subPrimarySquare_x + subSubPadding + subSubW;
		...
		this.subSubPrimarySquareBL_y = this.subPrimarySquare_y + subSubPadding + subSubW;
		...
		this.subSubPrimarySquareBR_x = this.subPrimarySquare_x + subSubPadding + subSubW;;
		this.subSubPrimarySquareBR_y = this.subPrimarySquare_y + subSubPadding + subSubW;;
	...
	draw() {
		...
		fill("#e9d8a6");
		rect(layout.subSubPrimarySquareTL_x, layout.subSubPrimarySquareTL_y, layout.subSubPrimarySquareTL_w, layout.subSubPrimarySquareTL_h);
		
		// subSubPrimarySquareTR
		fill("#e9d8a6");
		rect(layout.subSubPrimarySquareTR_x, layout.subSubPrimarySquareTR_y, layout.subSubPrimarySquareTR_w, layout.subSubPrimarySquareTR_h);
		
		// subSubPrimarySquareBL
		fill("#e9d8a6");
		rect(layout.subSubPrimarySquareBL_x, layout.subSubPrimarySquareBL_y, layout.subSubPrimarySquareBL_w, layout.subSubPrimarySquareBL_h);
		
		// subSubPrimarySquareBR
		fill("#e9d8a6");
		rect(layout.subSubPrimarySquareBR_x, layout.subSubPrimarySquareBR_y, layout.subSubPrimarySquareBR_w, layout.subSubPrimarySquareBR_h);
