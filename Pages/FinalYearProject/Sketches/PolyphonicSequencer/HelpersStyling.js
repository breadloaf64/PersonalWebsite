...
function makeButtons() {
	...
	btnPause = new Button(width - btnWidth - 20, height - btnHeight - 20, btnWidth, btnHeight, pauseUnpause, "pause")
	
	// quantise button
	btnQuantise = new Button(20, height - btnHeight - 20, btnWidth * 1.3, btnHeight, changeQuantisation, "quantise");
	
	// clear button
	btnClear = new Button(width - btnWidth - 20, height - (btnHeight * 2.2) - 20, btnWidth, btnHeight, clearVoices, "clear")
}