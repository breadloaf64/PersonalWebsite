class Scene_main {
    ...
    makeButtons() {
        ...
        this.btnIncreaseTempo = new Button(
            x + (1 * w) / 4,
            y + h * 1.5,
            w / 4,
            h / 2,
            increaseTempoFunction,
            '▲',
            txtSize,
            typeface,
            colButtonFill,
        ...
        this.btnDecreaseTempo = new Button(
            x + (1 * w) / 4,
            y + h * 1.5 + h / 2,
            w / 4,
            h / 2,
            decreaseTempoFunction,
            '▼',
            txtSize,
            typeface,
            colButtonFill,
        ...
        this.btnToggleMetronome = new Button(
            x + w / 2,
            y + h * 1.5,
            w / 2,
            h,
            toggleMetronomeFunction,
            toggleMetronomeText,
            txtSize,
            typeface,
            colTransparent,
    ...
    makeSequenceBoxButton(sequence, x, y, w, h, sequenceIndex) {
        ...
        const buttonPressFunction = function () {
            ...
            if (sequences[sequenceIndex].voices.length == 0) {
                // if sequence is clear, take photo
