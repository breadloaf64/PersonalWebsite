...
function setup() {
	...
	revealPanels = [];
	revealPanels.push(new RevealPanel(width *0.05, groundY + width * 0.01, width * 0.32, (height - groundY) * 0.95, colEarth));
	revealPanels.push(new RevealPanel(width *0.37, groundY + width * 0.01, width * 0.31, (height - groundY) * 0.95, colEarth));
	revealPanels.push(new RevealPanel(width *0.7, groundY + width * 0.01, width * 0.3, (height - groundY) * 0.95, colEarth));
	revealPanels.push(new RevealPanel(0, height * 0.85, width, height * 0.95, colEarth));
}
