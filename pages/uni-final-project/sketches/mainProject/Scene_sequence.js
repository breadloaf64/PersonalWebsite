class Scene_sequence {
    ...
    makeButtonsMain() {
        ...
        this.btnSelectPanelEdit = new Button(
            x + (w / 3) * 0,
            y + h * 1.5,
            w * 0.32,
            h / 2,
            selectPanelEditButtonPressFunction,
            'sequence',
            txtSize,
            typeface,
            colButtonFill,
        ...
        this.btnSelectPanelPitch = new Button(
            x + (w / 3) * 1,
            y + h * 1.5,
            w * 0.32,
            h / 2,
            selectPanelPitchButtonPressFunction,
            'pitch',
            txtSize,
            typeface,
            colButtonFill,
        ...
        this.btnSelectPanelTime = new Button(
            x + (w / 3) * 2,
            y + h * 1.5,
            w * 0.32,
            h / 2,
            selectPanelTimeButtonPressFunction,
            'time',
            txtSize,
            typeface,
            colButtonFill,
    ...
    makeButtonsEdit() {
        ...
        this.btnNewPhoto = new Button(
            x + (w - medW) / 2,
            y + h * 2 + (h - medH) / 2,
            medW,
            medH,
            newPhotoButtonPressFunction,
            'new photo',
            txtSize,
            typeface,
            colButtonFill,
    ...
    makeButtonsPitch() {
        ...
        if (sequences[currentSequenceIndex].quantisePitch)
            toggleSnapPitchText = '☑'
        ...
        this.btnToggleSnapPitch = new Button(
            x + w / 2,
            y + h * 2,
            w / 2,
            h,
            toggleSnapPitchButtonPressFunction,
            toggleSnapPitchText,
            txtSize,
            typeface,
            colTransparent,
        ...
        // preset text
        this.btnPresetScale = new Button(
            x,
            y + h * 3,
            w / 3,
            h,
        ...
        const presetScaleButtonPressFunction = function () {
            ...
            this.scene.btnPresetScale.text = getScaleName(
                sequences[currentSequenceIndex].scaleIndex
            )
        ...
        this.btnPresetScale = new Button(
            ...
            ((w * 2) / 3) * 0.9,
            h * 0.95,
            presetScaleButtonPressFunction,
            presetText,
            txtSize,
            typeface,
            colButtonFill,
        ...
        for (let i = 0; i < 12; i++) {
            ...
            let btnSN = new Button(
                snX,
                snY,
                snW,
                snH,
                snButtonPressFunction,
                notes[i],
                txtSize * 0.8,
                typeface,
                colSNButtonFillUnselected,
                colButtonBorder,
                colButtonText
            )
    ...
    makeButtonsTime() {
        ...
        if (sequences[currentSequenceIndex].quantiseTime)
            toggleSnapTimeText = '☑'
        ...
        this.btnToggleSnapTime = new Button(
            x + w / 2,
            y + h * 2,
            w / 2,
            h,
            toggleSnapTimeButtonPressFunction,
            toggleSnapTimeText,
            txtSize,
            typeface,
            colTransparent,
        ...
        // numBeats text box
        this.txtNumBeats = new Button(
            x + w / 2,
            y + h * 3,
            w / 4,
            h,
            function () {},
            sequences[currentSequenceIndex].numBeats,
            txtSize,
            typeface,
            colButtonFill,
            colButtonBorder,
        ...
        const increaseBeatsButtonPressFunction = function () {
            ...
            this.scene.txtNumBeats.text =
                this.scene.sequence.numBeats.toString()
        }
        this.btnIncreaseBeats = new Button(
            x + (3 * w) / 4,
            y + h * 3,
            w / 4,
            h / 2,
            increaseBeatsButtonPressFunction,
            '▲',
            txtSize,
            typeface,
            colButtonFill,
        ...
        const decreaseBeatsButtonPressFunction = function () {
            this.scene.sequence.setNumBeats(
                max(1, this.scene.sequence.numBeats - 1)
            )
            this.scene.txtNumBeats.text =
                this.scene.sequence.numBeats.toString()
        }
        this.btnDecreaseBeats = new Button(
            x + (3 * w) / 4,
            y + h * 3 + h / 2,
            w / 4,
            h / 2,
            decreaseBeatsButtonPressFunction,
            '▼',
            txtSize,
            typeface,
            colButtonFill,
        ...
        // speed text box
        this.txtSpeedMultiplier = new Button(
            x,
            y + h * 4 + h / 3,
            w / 2,
            h,
        ...
        this.txtSpeedMultiplierValue = new Button(
            x + w / 2,
            y + h * 4 + h / 3,
            w / 4,
            h,
        ...
        this.btnIncreaseSpeedMultiplier = new Button(
            x + (3 * w) / 4,
            y + h * 4 + h / 3,
            w / 4,
            h / 2,
            increaseSpeedMultiplierButtonPressFunction,
            '▲',
            txtSize,
            typeface,
            colButtonFill,
        ...
        this.btnDecreaseSpeedMultiplier = new Button(
            x + (3 * w) / 4,
            y + h * 4 + h / 2 + h / 3,
            w / 4,
            h / 2,
            decreaseSpeedMultiplierButtonPressFunction,
            '▼',
            txtSize,
            typeface,
            colButtonFill,
    ...
    drawPauseScreen() {
        if (!playing) {
            ...
            text(
                displayText,
                layout.subPrimarySquare_x + layout.subPrimarySquare_w / 2,
                layout.subPrimarySquare_y + layout.subPrimarySquare_h / 2
            )
        }
    }
